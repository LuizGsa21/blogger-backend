...
class ResourceArticlesTestCase(TestCase):
    ...
    def test_put_article_by_id(self):
        ...
        # attempt to update an article using a registered user without ownership. (This should fail)
        ...
        # attempt to update an article using a registered user with ownership. (This should NOT fail)
